clear all
clc
P2=150000;V1=300000;V2=250000;pi1=42000;pi2=18000;
c1=110;c2=420;c3=240;C3=500;C4=700;C5=60000;R6=500;R1=50000;R2=35000;R3=40000;gama=15000; n1=0.26;tao1=0.1;F=2000;
P1=100000;
for i=0.27
    figure(1)
...
for k=0.64
    ...
    grid off
    hold on  
    legend({'P1=100000','P1=150000','P1=210000'},'location','northeast');
