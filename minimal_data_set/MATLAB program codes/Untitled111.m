...
for i=0.27
    ...
    plot3(y(:,1),y(:,2),y(:,3),'ks-','linewidth',1);
    hold on
end
for i=0.27
    [t,y]=ode45(@(t,y) nec(t,y,P1,P2,V1,V2,pi1,pi2,c1,c2,c3,C3,C4,C5,R6,R1,R2,R3,F,gama,n1,tao1),[0 120],[i 0.8 0.84]);
    plot3(y(:,1),y(:,2),y(:,3),'k*-','linewidth',1);
    hold on
end
for i=0.57   
    [t,y]=ode45(@(t,y) nec(t,y,P1,P2,V1,V2,pi1,pi2,c1,c2,c3,C3,C4,C5,R6,R1,R2,R3,F,gama,n1,tao1),[0 120],[i 0.4 0.64]);
    plot3(y(:,1),y(:,2),y(:,3),'ko-','linewidth',1);
    hold on
end

for i=0.57
    [t,y]=ode45(@(t,y) nec(t,y,P1,P2,V1,V2,pi1,pi2,c1,c2,c3,C3,C4,C5,R6,R1,R2,R3,F,gama,n1,tao1),[0 120],[i 0.8 0.84]);
    plot3(y(:,1),y(:,2),y(:,3),'kh-','linewidth',1);
    axis([0 1 0 1 0 1])
