...
c1=110;c2=420;c3=240;C3=500;C4=700;C5=60000;R6=500;R1=50000;R2=35000;R3=40000;gama=15000; n1=0.26;tao1=100000;F=2000;
n1=0.3;
for i=0.27
    figure(1)
...
for k=0.64
    ...
    grid off
    hold on  
    legend({'n1=0.3','n1=0.5','n1=0.8'},'location','northeast');
