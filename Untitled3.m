...
c1=110;c2=420;c3=240;C3=500;C4=700;C5=60000;R6=500;R1=50000;R2=35000;R3=40000;gama=15000; n1=0.26;tao1=0.1;
F=500;
for i=0.27
    figure(1)
...
for k=0.64
    ...
    grid off
    hold on  
    legend({'F=500','F=2000','F=10000'},'location','northeast');
